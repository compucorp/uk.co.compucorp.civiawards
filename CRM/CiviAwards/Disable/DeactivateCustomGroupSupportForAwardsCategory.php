...
/**
 * Class DeactivateCustomGroupSupportForAwardsCategory.
 */
class CRM_CiviAwards_Disable_DeactivateCustomGroupSupportForAwardsCategory {

  /**
   * Deactivate the Awards option from the CG Extends option values.
   */
  public function apply() {
    ...
    foreach ($applicantCaseCategoryIds as $caseCategoryValue) {
      $caseCategoryCustomFieldExtends->deactivate($caseCategoryDetails[$caseCategoryValue]);
    }
  }
