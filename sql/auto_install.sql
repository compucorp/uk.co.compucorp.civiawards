...
,
    ...
    ,     UNIQUE INDEX `unique_case_type`(
        case_type_id
  )
  
,          CONSTRAINT FK_civicrm_civiawards_award_detail_case_type_id FOREIGN KEY (`case_type_id`) REFERENCES `civicrm_case_type`(`id`) ON DELETE CASCADE,          CONSTRAINT FK_civicrm_civiawards_award_detail_profile_id FOREIGN KEY (`profile_id`) REFERENCES `civicrm_uf_group`(`id`)   
)    ;
...
,
    ...
    ,     UNIQUE INDEX `unique_case_type_manager`(
        contact_id
      , case_type_id
  )
  
,          CONSTRAINT FK_civicrm_civiawards_award_manager_contact_id FOREIGN KEY (`contact_id`) REFERENCES `civicrm_contact`(`id`) ,          CONSTRAINT FK_civicrm_civiawards_award_manager_case_type_id FOREIGN KEY (`case_type_id`) REFERENCES `civicrm_case_type`(`id`) ON DELETE CASCADE  
)    ;
...
,
    ...
    ,     UNIQUE INDEX `unique_case_type_panel_title`(
        title
      , case_type_id
  )
